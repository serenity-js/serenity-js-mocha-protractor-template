...
> **⚠️ Protractor is deprecated.** This template uses [Protractor](https://www.protractortest.org/), which reached end-of-life in 2023. For new projects, use one of the actively maintained templates instead:
...
> - [Serenity/JS with WebdriverIO](https://github.com/serenity-js/serenity-js-mocha-webdriverio-template)
...
of web applications using [**Serenity/JS**](https://serenity-js.org), [**Mocha**](https://mochajs.org/), and [**Protractor**](http://www.protractortest.org/),
and comes pre-configured with **TypeScript**, linting, reporting, and example test scenarios.

Use this template to accelerate your test automation setup and generate [Serenity/JS HTML Reports](https://serenity-js.org/handbook/reporting/html-reporter/) with trend history, flaky test detection, and error clustering.

View live reports generated by this template:
- [Serenity/JS HTML Report](https://serenity-js.github.io/serenity-js-mocha-protractor-template/)

## Features

- Pre-configured **Serenity/JS** + **Mocha** + **Protractor** + **TypeScript** setup
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?ref=main&repo=serenity-js/serenity-js-mocha-protractor-template)
...
- [Node.js](https://nodejs.org/) (LTS version 20 or later)
...
The report is generated automatically in `./reports/serenity-js/` when the tests complete.

#### 5. View reports

Open `./reports/serenity-js/index.html` directly in your browser, or serve the report locally:
```
npm run test:report
```
...
npm run test:report     # serves the generated report and opens it in the browser
```
...
```
spec/
└── serenity-js_website.spec.ts           # Example test specification

reports/serenity-js/                      # Generated Serenity/JS HTML Report (gitignored)

protractor.conf.js                        # Protractor configuration
```

**Key files:**
- `spec/*.spec.ts` - Test specifications using Mocha and the [Screenplay Pattern](https://serenity-js.org/handbook/design/screenplay-pattern/)

## Next steps

- ⚠️ Consider [migrating to Playwright](https://serenity-js.org/handbook/test-runners/playwright-test/) or [WebdriverIO](https://serenity-js.org/handbook/test-runners/webdriverio/) — Protractor is end-of-life
- Update `baseUrl` in [`protractor.conf.js`](protractor.conf.js) to point to your application
...
- [Using Serenity/JS with Mocha](https://serenity-js.org/handbook/test-runners/mocha/)
