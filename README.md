...
- Integrated reporting with **Serenity/JS HTML Reports** — trend history, flaky test detection, error clustering, and an interactive dashboard
...
Follow the [Serenity/JS installation guide](https://serenity-js.org/handbook/installation/) to set up your development environment with the following prerequisites:
